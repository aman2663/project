...
const Card = ({ value }) => {
  ...
  return (
    <div className="product-main">
      <img src={productImage} alt="product-img" style={{width:'366px',height:'307px',backgroundSize:'cover'}}/>
      <div className="pdname">
        <p>{productName}</p>
        {wish.includes(value)?<svg onClick={()=>removeFromWishlist(value)}
          width="16"
          height="15"
          viewBox="0 0 16 15"
          fill="none"
        ...
        >
          <path
            ...
            fill="#23A6F0"
          />
        </svg>:<svg onClick={()=>addToWishlist(value)}
